...
//digunakan untuk menyimpan dan membuat data  dimana data disini disimpan dalam array
object HeroesData {
    ...
    //digunakna untuk membuat array list yang isinya berisikan data dalam indek
